...
from zoya.views import show_main, show_json_tempat, show_json_forum, add_forum_entry_ajax, get_user_by_id, get_current_user_id, delete_forum_entry, show_json_makanan, edit_forum_entry, create_forum_flutter, edit_forum_flutter, delete_forum_flutter, show_json_user_by_id, show_json_current_user, show_json_forum_by_id
...
urlpatterns = [
    ...
    path('json-current-user/', show_json_current_user, name='show_json_current_user'),
    path('create-flutter/', create_forum_flutter, name='create_forum_flutter'),
    path('edit-flutter/<uuid:forum_id>/', edit_forum_flutter, name='edit_forum_flutter'),
    path('delete-flutter/<uuid:forum_id>/', delete_forum_flutter, name='delete_forum_flutter'),
]
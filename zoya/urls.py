...
from zoya.views import show_main, show_json_tempat, show_json_forum, add_forum_entry_ajax, get_user_by_id, get_current_user_id, delete_forum_entry, edit_forum_entry
...
urlpatterns = [
    ...
    path('edit-forum/<int:id>/', edit_forum_entry, name='edit_forum_entry'),
    path('delete-forum/<int:id>/', delete_forum_entry, name='delete_forum_entry'),

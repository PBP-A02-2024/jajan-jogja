...
from .views import create_resto_flutter, edit_resto_flutter, delete_resto_flutter, show_json_variasi, get_restaurant_detail
app_name = 'alfian'
...
urlpatterns = [
    ...
    path('get-resto-detail/<uuid:tempatKulinerId>/', get_restaurant_detail, name='get_restaurant_detail'),
